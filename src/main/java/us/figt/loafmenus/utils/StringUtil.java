...
public final class StringUtil {
    ...
    public static boolean equalsTranslateColors(@NonNull String string1, @NonNull String strign2) {
        return translateColors(strign2).equals(translateColors(strign2));
    }
}
